...
namespace CayBua\Export;

use CayBua\Export\Documentation\ApiCollection as DocumentationCollection;
...
class Documentation extends Plugin
{
    ...
    public function addCollection(ApiCollection $apiCollection)
    {
        ...
        foreach ($apiCollection->getEndpoints() as $apiEndpoint) {
            ...
            $endpoint->setExampleParameters($apiEndpoint->getExampleParameters());
            $endpoint->setExampleHeaders($apiEndpoint->getExampleHeaders());
